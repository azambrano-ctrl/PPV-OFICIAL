    ...
    return (
        <div className="min-h-screen bg-dark-950 pt-24 pb-12 px-4">
            <div className="max-w-5xl mx-auto">
                <h1 className="text-4xl font-bold mb-8 gradient-text text-center">Centro de Ayuda</h1>
                ...
                <div className="bg-dark-900 border border-dark-800 rounded-2xl p-8 text-center">
                    ...
                    <p className="text-dark-400 mb-6">Nuestro equipo de soporte está disponible 24/7 durante los eventos.</p>
                    <div className="flex justify-center gap-4">
                        <Link href="/contact" className="btn btn-primary px-8">Contactar Soporte</Link>
