    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-dark-950 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-md w-full relative z-10">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center">
                            <button
                                ...
                                className="px-4 py-1 bg-dark-900 text-dark-400 text-sm hover:text-primary-500 transition-colors cursor-pointer"
                            >
                                O continúa con
                            </button>
                        </div>
                ...
                {/* Social Auth Modal */}
                {showSocialModal && (
                    <SocialAuthModal onClose={() => setShowSocialModal(false)} />
                )}
            </div>
        </div>
    );
