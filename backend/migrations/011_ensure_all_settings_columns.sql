-- Ensure all settings columns exist (repair migration)
-- This migration repeats previous column additions with IF NOT EXISTS to ensure
-- the schema is correct even if previous migrations were skipped or failed.
...
COMMENT ON TABLE settings IS 'Application-wide settings and configuration (verified schema)';
